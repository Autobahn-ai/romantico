    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription>Sign in to access your team&apos;s email templates</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button
            ...
            disabled={loading}
            className="w-full h-11 gap-3 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 shadow-sm"
            variant="outline"
          >
            {loading ? (
          ...
          <p className="text-xs text-center text-muted-foreground">
            ...
            We request Drive access to enable file attachments.
          </p>
        </CardContent>
      </Card>
    </div>
